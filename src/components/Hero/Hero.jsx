        ...
        <div className="hero min-h-screen flex items-center justify-center text-white">
          <div>
            ...
            <div className="flex flex-col items-center space-y-4 sm:flex-row sm:space-x-32 sm:space-y-0 justify-center">
              <button className="bg-[#304ce4] hover:shadow-lg px-12 py-4 rounded-lg text-white text-xl md:text-3xl  flex items-center">
                <span className="mr-4">Register</span>
                <img src={"Images/devfolio.png"} alt="devfolio logo" className="w-6 h-6 ml-3" />
              </button>
              <button className="bg-[#5c54f4] hover:shadow-lg px-12 py-4 rounded-lg text-white text-xl md:text-3xl flex items-center">
