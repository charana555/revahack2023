      ...
      <div 
        ...
        <div class="card">
          ...
          <div 
            ...
            <p>Ctrl+C Ctrl+V to the Future: Hacking Tomorrow's Universe with AI</p>
          </div>
        </div>
        {/* card2 */}
        <div class="card">
        <div id="img"
          ...
          <div 
            id="content" 
            className="absolute top-60 left-5 right-4 text-center items-center z-1">
            <p>Building the Future on Immutable Blocks: Hack the Potential of Blockchain</p>
          </div>
        </div>
        {/* card3 */}
        <div class="card">
        ...
        <div id="img"
          ...
          <div 
            id="content" 
            className="absolute top-60 left-5 right-4 text-center items-center z-1">
            <p>Code in the Cloud, Control the World: Building Smart Solutions with IoT and Cloud</p>
          </div>
        </div>
        {/* card5 */}
        <div class="card">
