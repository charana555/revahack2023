...
const Banner = (props) => {
  return (
    <section className="  flex flex-col text-white text-center text-3xl items-center justify-center pixel-bg mb-20">
      ...
      <div className="flex flex-col justify-center items-center mx-auto glassmorphic-card w-[90%] md:max-w-[60%] m-auto py-8 text-center">
        <div className="main text-white font-bold md:text-5xl text-4xl xs:text-4xl">
