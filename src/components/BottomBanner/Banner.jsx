...
const Banner = (props) => {
  return (
    <section className="flex flex-col text-white text-center text-3xl items-center justify-center pixel-bg my-20">
      {/* <div id="img" className="h-auto justify-center items-center">
        <img src="./Images/pixel.svg" alt="pixel" className="absolute w-[100%] h-[50%]" />
      </div> */}
          <div className="flex flex-col justify-center items-center mx-auto glassmorphic-card w-[60%] md:max-w-[40%] py-8 text-center">
