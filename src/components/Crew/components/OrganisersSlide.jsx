    ...
    <>
      <div className="flex flex-col justify-center gap-10">
        ...
        <div id="teamMembers" className="flex flex-wrap justify-center gap-8">
          <div className="crewCard glassmorphic-card">
            <div className="card-photo">
              <img src={mohit} alt="lead photo" loading="lazy" />
            </div>
            ...
            <div className="card-socials">
              <a
                href="https://instagram.com/_ironman_20?utm_source=qr&igshid=MzNlNGNkZWQ4Mg==
"
                class="card-socials-btn"
                target="_blank"
              >
              ...
              <a
                href="https://GitHub.com/mohit20kumar
"
                class="card-socials-btn"
                target="_blank"
              >
              ...
              <a
                href="https://linkedin.com/in/mohit20kumar
"
                class="card-socials-btn"
                target="_blank"
              >
          ...
          <div className="crewCard glassmorphic-card">
            <div className="card-photo">
              <img src={Aish} alt="lead photo" loading="lazy" />
            </div>
            ...
            <div className="card-socials">
              ...
              <a
                href="https://www.linkedin.com/in/aishwarya-radder
"
                class="card-socials-btn"
                target="_blank"
              >
