        ...
        <div id="teamLead" className="flex flex-wrap gap-8 justify-center">
          <div className="membercard glassmorphic-card">
            <div className="card-photo">
              <img src={raj} alt="memeber photos" loading="lazy" />
            </div>
            <div className="card-title">Rajshekar</div>

            <div className="card-socials">
              <a
                href="https://www.instagram.com/0_0rajshekar/
"
              ...
              <a
                href="https://github.com/rajshekar723
"
                class="card-socials-btn"
                target="_blank"
              >
              ...
              <a
                href="https://www.linkedin.com/in/rajshekar-870a92223/
"
                class="card-socials-btn"
                target="_blank"
              >
          ...
          <div className="membercard glassmorphic-card">
            <div className="card-photo">
              <img src={aryan} alt="memeber photos" loading="lazy" />
            </div>
            <div className="card-title">Aryan</div>

            <div className="card-socials">
              <a
                href="https://www.instagram.com/xaryxn_/
"
                class="card-socials-btn"
                target="_blank"
              >
              ...
              <a
                href="https://www.linkedin.com/in/aryan-thacker/
"
                class="card-socials-btn"
                target="_blank"
              >
        ...
        <div id="teamMembers" className="flex flex-wrap justify-center gap-8">
          <div className="membercard glassmorphic-card">
            <div className="card-photo">
              <img src={aashish} alt="memeber photos" loading="lazy" />
            </div>
            <div className="card-title">Aashish</div>

            <div className="card-socials">
              <a
                href="https://www.instagram.com/https.niishith/
"
                class="card-socials-btn"
                target="_blank"
              >
              ...
              <a
                href="https://github.com/Niishith
"
                class="card-socials-btn"
                target="_blank"
              >
              ...
              <a
                href="linkedin.com/in/aashish-r-goudar-8503a7245
"
                class="card-socials-btn"
                target="_blank"
              >
          ...
          <div className="membercard glassmorphic-card">
            <div className="card-photo">
              <img src={nagesh} alt="memeber photos" loading="lazy" />
            </div>
            <div className="card-title">Nagesh </div>

            <div className="card-socials">
              <a
                href="https://instagram.com/__nagesh_patil_?utm_source=qr&igshid=MzNlNGNkZWQ4Mg==
"
                class="card-socials-btn"
                target="_blank"
              >
...
"
          ...
          <div className="membercard glassmorphic-card">
            <div className="card-photo">
              <img src={gaurav} alt="memeber photos" loading="lazy" />
            </div>
            <div className="card-title">Gaurav </div>

            <div className="card-socials">
              <a
                href="https://instagram.com/gaurav_ksh_?igshid=OGQ5ZDc2ODk2ZA==
"
                class="card-socials-btn"
                target="_blank"
              >
              ...
              <a
                href="https://github.com/gauravksh
"
                class="card-socials-btn"
                target="_blank"
              >
              ...
              <a
                href="https://www.linkedin.com/in/gauravksh1609
"
                class="card-socials-btn"
                target="_blank"
              >
          ...
          <div className="membercard glassmorphic-card">
            <div className="card-photo">
              <img src={samuel} alt="memeber photos" loading="lazy" />
            </div>
            <div className="card-title">Samuel </div>
...
"
              ...
              <a
                href="https://www.linkedin.com/in/mr-dj/
"
                class="card-socials-btn"
                target="_blank"
              >
          ...
          <div className="membercard glassmorphic-card">
            <div className="card-photo">
              <img src={Soumya} alt="memeber photos" loading="lazy" />
            </div>
            <div className="card-title">Soumyajit </div>

            <div className="card-socials">
              <a
                href="https://instagram.com/soumyajiitttt?igshid=OGQ5ZDc2ODk2ZA==
"
                class="card-socials-btn"
                target="_blank"
              >
...
"
              ...
              <a
                href="https://www.linkedin.com/in/soumyajiitttt
"
                class="card-socials-btn"
                target="_blank"
              >
