  ...
  return (
    <section className="flex gap-2 py-2">
      <div class="social-buttons">
        <a href="https://github.com/revahack" class="social-button github">
          <svg
            class="cf-icon-svg"
        ...
        <a href="https://discord.gg/XtQkGMKuD4" class="social-button discord">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="800px"
            height="800px"
        ...
        <a
          href="https://instagram.com/officialrevahack2023?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"
        ...
        <a
          href="https://youtube.com/@OfficialRevaHack?si=wxfdUIevUv7SUzRo"
